...
import 'package:heart_safe/screens/question_forum_screen/question_replies_screen.dart';
...
class _MyQuestionsState extends State<MyQuestions> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar:
            DefaultAppBar(context: context, title: const Text("My Questions")),
  ...
  ListTile myQuestionListTile(int questionIndex) {
    isLiked = widget.questionForumModel.likedQuestionsList.contains(widget
        .questionForumModel.myQuestionsList[questionIndex]
        .getQuestionID());
    var futureAuthor =
        widget.questionForumModel.myQuestionsList[questionIndex].getAuthor();
    ...
    return ListTile(
      title: Text(
          widget.questionForumModel.myQuestionsList[questionIndex]
              .getQuestion(),
          style:
  ...
  SizedBox likeButton(int questionIndex) {
    return SizedBox(
      ...
      child: LikeButton(
          ...
          bubblesSize: 0,
          likeCount:
              widget.questionForumModel.myQuestionsList[questionIndex].numLikes,
          isLiked: isLiked,
          onTap: (bool isLiked) {
            this.isLiked = !isLiked;
            (isLiked)
                ? widget.questionForumModel.unlikeQuestion(widget
                    .questionForumModel.questionsList
                    .indexWhere((element) =>
                        element.getQuestionID() ==
                        widget.questionForumModel.myQuestionsList[questionIndex]
                            .getQuestionID()))
                : widget.questionForumModel.likeQuestion(widget
                    .questionForumModel.questionsList
                    .indexWhere((element) =>
                        element.getQuestionID() ==
                        widget.questionForumModel.myQuestionsList[questionIndex]
